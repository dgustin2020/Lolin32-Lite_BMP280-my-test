...
function getReadings(){
  ...
  xhr.onreadystatechange = function() {
    if (this.readyState == 4 && this.status == 200) {
      ...
      document.getElementById("clock").innerHTML = myObj.clock;
      document.getElementById("txt").innerHTML = myObj.my_txt;
      //document.getElementById("alti").innerHTML = myObj.alti;
    }
  }; 
